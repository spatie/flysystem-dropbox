...
This package contains an [Flysystem](https://flysystem.thephpleague.com/) adapter for Dropbox. Under the hood [v2 of the Dropbox API](https://www.dropbox.com/developers/documentation/http/overview) is used.
